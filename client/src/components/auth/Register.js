                        ...
                        <div className="col-md-8 m-auto">
                            ...
                            <form onSubmit={this.onSubmit}>
                                <div className="form-group">
                                    <input onChange={this.onChange} value={this.state.name} type="text" className={classnames("form-control form-control-lg", {'is-invalid': errors.name})} placeholder="Name" name="name" />
                                ...
                                <div className="form-group">
                                    <input  onChange={this.onChange} value={this.state.password2} type="password" className={classnames("form-control form-control-lg", {'is-invalid': errors.password2})} placeholder="Confirm Password" name="password2" />
